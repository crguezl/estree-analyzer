...
exports.ObjectEnvironmentRecord = exports.ModuleEnvironmentRecord = exports.LexicalEnvironment = exports.GlobalEnvironmentRecord = exports.FunctionEnvironmentRecord = exports.EnvironmentRecord = exports.DeclarativeEnvironmentRecord = exports.BindingStatus = void 0;
...
class DeclarativeEnvironmentRecord extends EnvironmentRecord {
  ...
  createMutableBinding(name, deletable) {
    (0, _assert.default)(!this.hasBinding(name));
    this.bindings[name] = {
      mutable: true,
      initialized: false,
      deletable
  ...
  initializeBinding(name, value) {
    ...
    (0, _assert.default)(binding && !binding.initialized);
    binding.value = value;
  ...
  getBindingValue(name) {
    const binding = this.bindings[name]; // assert(binding);
...
class ObjectEnvironmentRecord extends EnvironmentRecord {
  ...
  createImmutableBinding() {
    _assert.default.fail('ObjectEnvironmentRecord.createImmutableBinding is never used');
  }
...
class FunctionEnvironmentRecord extends DeclarativeEnvironmentRecord {
  constructor(functionObject, newTarget) {
    ...
    this.thisBindingStatus = functionObject.thisMode === _function.ThisMode.Lexical ? BindingStatus.Lexical : BindingStatus.Uninitialized;
  ...
  bindThisValue(value) {
    (0, _assert.default)(this.thisBindingStatus !== BindingStatus.Lexical);
...
class ModuleEnvironmentRecord extends DeclarativeEnvironmentRecord {
  ...
  createImportBinding(name, module, nameInModule) {
    (0, _assert.default)(!this.hasBinding(name));
    (0, _assert.default)(module.environment);
    (0, _assert.default)(module.environment.record.hasBinding(nameInModule));
    this.bindings[name] = {
      mutable: false,
      initialized: true,
      strict: true,
